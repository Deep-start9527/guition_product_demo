 ...
 */
#if ESP32_2432S032C
#define ESP_PANEL_BOARD_NAME                "custom:ESP32-2432S032C"
#elif ESP32_2432S032R
#define ESP_PANEL_BOARD_NAME                "custom:ESP32-2432S032R"
#elif ESP32_2432S032N
#define ESP_PANEL_BOARD_NAME                "custom:ESP32-2432S032N"
#endif
 ...
 */
#if ESP32_2432S032C || ESP32_2432S032R
 ...
 */
    ...
    #define ESP_PANEL_BOARD_TOUCH_I2C_IO_SCL            (32)
    #define ESP_PANEL_BOARD_TOUCH_I2C_IO_SDA            (33)
#endif
    /* For panel */
 ...
 */
#define ESP_PANEL_BOARD_TOUCH_RST_IO            (25)    // Reset pin, -1 if not used
...
#define ESP_PANEL_BOARD_BACKLIGHT_TYPE          (ESP_PANEL_BACKLIGHT_TYPE_PWM_LEDC)
     ...
     */
    #define ESP_PANEL_BOARD_BACKLIGHT_IO        (27)    // Output GPIO pin number
