...
#define ESP_PANEL_BOARD_NAME                "custom:JC3636K518"
 ...
 */
    ...
    /* For host */
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_SCK         (11)
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA0       (13)
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA1       (14)
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA2       (15)
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA3       (16)
 ...
 */
#define ESP_PANEL_BOARD_LCD_RST_IO              (17)    // Reset pin, -1 if not used
 ...
 */
    ...
    #define ESP_PANEL_BOARD_TOUCH_I2C_IO_SDA            (9)
#endif
    /* For panel */
 ...
 */
#define ESP_PANEL_BOARD_TOUCH_RST_IO            (8)    // Reset pin, -1 if not used
