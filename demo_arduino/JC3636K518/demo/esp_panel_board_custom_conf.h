...
#define ESP_PANEL_BOARD_NAME                "custom:JC3636K718"
 ...
 */
    ...
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA0       (15)
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA1       (16)
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA2       (17)
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA3       (18)
#endif // ESP_PANEL_BOARD_LCD_BUS_SKIP_INIT_HOST
    /* For panel */
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_CS          (14)    // -1 if not used
 ...
 */
#define ESP_PANEL_BOARD_TOUCH_RST_IO            (10)    // Reset pin, -1 if not used
